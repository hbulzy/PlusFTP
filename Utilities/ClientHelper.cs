...
namespace Hani.Utilities
{
    internal static partial class ClientHelper
    {
        ...
        internal static async Task<bool> ConnectAsync()
        {
            ...
            mainClient.OnConnecting += new NetworkClient.StateHandler(Connecting);
            mainClient.OnConnected += new NetworkClient.StateHandler(Connected);
            mainClient.OnDisconnected += new NetworkClient.StateHandler(Disconnected);
