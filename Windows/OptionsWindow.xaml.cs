...
namespace PlusFTP.Windows
{
    public partial class OptionsWindow : MahApps.Metro.Controls.MetroWindow
    {
        ...
        private void CheckBoxSaveSameLocation_Checked(object sender, RoutedEventArgs e)
        {
            ...
            {
                string[] appPaths = new string[] { AppSettings.FileAppPath, ProfileOptimizer.FileAppPath, Users.FileAppPath, AppHistory.FileAppPath };
                string[] roamingPaths = new string[] { AppSettings.FileRoamingPath, ProfileOptimizer.FileRoamingPath, Users.FileRoamingPath, AppHistory.FileRoamingPath };
